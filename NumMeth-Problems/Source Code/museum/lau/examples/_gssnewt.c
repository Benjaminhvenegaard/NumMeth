...
int expfunct(int m, int n,float par[], float g[])
{
	int i;
...
void jacobian(int m, int n, float par[], float g[], float **jac)
{
	int i;
	float ex;
...
void main ()
{
	...
	void gssnewton(int, int, float [], float [], float **,
						int (*)(int, int, float[], float[]),
						void (*)(int, int, float[], float[], float **),
						float [], float []);
	float in[8],out[10],g[7],par[4],**v;
