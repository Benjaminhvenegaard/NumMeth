...
void communication(int post, float fa, int n, int m, int nobs,
		int nbp, float par[], float res[], int bp[], float **jtjinv,
		float in[], float out[], int weight, int nis)
{
...
int jacdfdp(int n, int m, float par[], float y[], float x,
				float **fp)
{
	float y2;
...
void data(int nobs, float tobs[], float obs[], int cobs[])
{
	int i;
	static float a[23]={0.0002, 0.0004, 0.0006, 0.0008, 0.001,
			0.0012, 0.0014, 0.0016, 0.0018, 0.002, 0.02, 0.04, 0.06,
			0.08, 0.1, 1.0, 2.0, 5.0, 10.0, 15.0, 20.0, 25.0, 30.0};
	static float b[23]={0.1648, 0.2753, 0.3493, 0.3990, 0.4322,
...
void callystart(int n, int m, float par[], float y[], float ymax[])
{
	y[1]=ymax[1]=ymax[2]=1.0;
	y[2]=0.0;
}

int deriv(int n, int m, float par[], float y[], float x,
			float df[])
{
	float y2;
...
int jacdfdy(int n, int m, float par[], float y[], float x,
				float **fy)
{
	fy[1][1] = -1.0+y[2];
...
void monitor(int post, int ncol, int nrow, float par[],
		float res[], int weight, int nis)
{
}
...
void main ()
{
	...
	void peide(int, int, int, int *, float [], float [],
			...
			void (*)(int,int,int,float [],float [],int,int));
	int m,n,nobs,nbp,bp[4];
	float fa,par[7],res[27],**jtjinv,in[7],out[8];
