...
void out2(float **u, int lj, int uj, int ll, int ul, int *p,
...
void main ()
{
	...
	void richardson(float **, int, int, int, int,
			...
			void (*)(float **, int, int, int, int, int *, float [],
						int, float, float));
	void elimination(float **, int, int, int, int,
			void (*)(int, int, int, int, float **),
			float, float, int *, float [], int *, float *, float *,
			void (*)(float **, int, int, int, int, int *, float [],
							int, float, float));
	int j,l,lj,uj,ll,ul,n,p,k;
	float pi,domeigval,rateconvr,rateconve,rateconv,a,b,discr[3],**u;
