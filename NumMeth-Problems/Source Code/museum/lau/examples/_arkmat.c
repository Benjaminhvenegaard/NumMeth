int tel;
float h1k,h2k,hpi,h1,h2;

#include <stdio.h>
#include <math.h>

void der(int m, int n, float t, float **u, float **du)
{
	int i,j;
...
void out(float t, float te, int m, int n, float **u, int type,
			int order, float *spr)
{
	int i;
...
void main ()
{
	...
	void arkmat(float *, float, int, int, float **,
		void (*)(int, int, float, float **, float **),
		int, int *, float *,
		void (*)(float, float, int, int, float **, int, int, float *));
	int i,j,n,m,typ,orde;
	float **u,t,te,cos1,spr;
