...
int expfunct(int m, int n,float par[], float rv[])
{
	int i;
...
void jacobian(int m, int n, float par[], float rv[], float **jac)
{
	int i;
	float ex;
...
void main ()
{
	...
	void marquardt(int, int, float [], float [], float **,
						int (*)(int, int, float[], float[]),
						void (*)(int, int, float[], float[], float **),
						float [], float []);
	float in[7],out[8],rv[7],par[4],**jjinv;
