...
void der(int r, float y[], float *delta)
{
	float y1,y2;
...
void jac(int r, float **j, float y[], float *delta)
{
	float y1,y2;
...
void outp(float x, float xe, int r, float y[], float delta,
...
void main ()
{
	void gms(float *, float, int, float [], float, float,
			float, float *, void (*)(int, float [], float *),
