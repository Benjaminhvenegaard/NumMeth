...
void airy(float z, float *ai, float *aid, float *bi, float *bid,
			float *expon, int first)
{
	int n,l;
	float s,t,u,v,sc,tc,uc,vc,x,k1,k2,k3,k4,c,zt,si,co,expzt,sqrtz,wwl,
			pl,pl1,pl2,pl3;
	static float c1,c2,sqrt3,sqrt1opi,pio4,xx[11],ww[11];
