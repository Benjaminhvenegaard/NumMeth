...
void nonexpbessk01(float x, float *k0, float *k1)
{
	if (x <= 1.5) {
		...
		*k1 *= expx;
		...
		int i,r;
		float t2,s1,s2,term1,term2,sqrtexpr,exph2,x2;
		static float fac[20]={0.90483741803596, 0.67032004603564,
		...
		*k1 = exph2*s2*2.0;
		...
		int r,i;
		float br,br1,br2,cr,cr1,cr2,ermin1,erplus1,er,f0,f1,
				expx,y,y2;
		static float dr[14]={0.27545e-15, -0.172697e-14,
