...
void diffsys(float *x, float xe, int n, float y[],
				void (*derivative)(int, float, float [], float []),
				float aeta, float reta, float s[], float h0,
				void (*output)(int, float, float, float [], float []))
{
	...
	float a,b,b1,c,g,h,u,v,ta,fc,*ya,*yl,*ym,*dy,*dz,**dt,d[7],
			**yg,**yh;
