...
void elimination(float **u, int lj, int uj, int ll, int ul,
			void (*residual)(int, int, int, int, float **),
			float a, float b, int *n, float discr[], int *k,
			float *rateconv, float *domeigval,
			void (*out)(float **, int, int, int, int, int *, float [],
							int, float, float))
{
	...
	void richardson(float **, int, int, int, int,
			...
			void (*)(float **, int, int, int, int, int *, float [],
							int, float, float));
	float optpol(float, float, float, float);
	int ext,extrapolate;
	float pi,auxcos,c,d,
...
float optpol(float x, float a, float b, float domeigval)
{
