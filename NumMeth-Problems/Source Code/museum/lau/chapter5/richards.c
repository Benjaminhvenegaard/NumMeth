...
void richardson(float **u, int lj, int uj, int ll, int ul,
			int inap, void (*residual)(int, int, int, int, float **),
							...
							int, float, float))
{
	...
	int j,l;
	float x,y,z,y0,c,d,alfa,omega,omega0,eigmax,eigeucl,euclres,maxres,
