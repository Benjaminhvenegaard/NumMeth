...
void rk2(float *x, float a, float b, float *y, float ya,
			float *z, float za, float (*fxyz)(float, float, float),
			float e[], float d[], int fi)
{
	int last,first,reject,test,ta,tb;
	float e1,e2,e3,e4,xl,yl,zl,h,ind,hmin,hl,absh,k0,k1,k2,k3,k4,
