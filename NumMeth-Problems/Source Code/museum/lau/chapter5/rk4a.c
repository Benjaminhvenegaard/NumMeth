...
void rk4a(float *x, float xa, float (*b)(float, float),
			float *y, float ya, float (*fxy)(float, float),
			float e[], float d[], int fi, int xdir, int pos)
{
	...
	float k0,k1,k2,k3,k4,k5,fhm,absh,discr,s,xl,cond0,s1,cond1,
...
void rk4arkstep(float *x, float xl, float h, float *y, float yl,
			float zl, float (*fxy)(float, float), int d,	int invf,
			float *k0, float *k1, float *k2, float *k3, float *k4,
			float *k5, float *discr, float mu)
{
