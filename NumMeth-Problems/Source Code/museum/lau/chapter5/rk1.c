...
void rk1(float *x, float a, float b, float *y, float ya,
			float (*fxy)(float, float), float e[], float d[], int fi)
{
	int last,first,reject,test,ta,tb;
	float e1,e2,xl,yl,h,ind,hmin,absh,k0,k1,k2,k3,k4,k5,discr,tol,mu,
			mu1,fh,hl;
