...
void marquardt(int m, int n, float par[], float g[], float **v,
					int (*funct)(int, int, float[], float[]),
					void (*jacobian)(int, int, float[], float[], float **),
					float in[], float out[])
{
	...
	float vv,ww,w,mu,res,fpar,fparpres,lambda,lambdamin,p,pw,reltolres,
