...
void modifiedtaylor(float *t, float te, int m0, int m, float u[],
			float (*sigma)(float, int, int), float taumin,
			void (*derivative)(float, int, int, int, float []),
			int *k, float data[], float alfa, int norm,
							...
							int, float, float))
{
	...
	float ec0,ec1,ec2,tau0,tau1,tau2,taus,t2,t0,tau,taui,tauec,
