...
float tricub(float xi, float yi, float xj, float yj, float xk,
				float yk, float (*g)(float,float), float re, float ae)
{
	float tricubint(float, float, float, float,
...
float tricubint(float ax1, float ay1, float af1, float ax2,
			float ay2, float af2, float ax3, float ay3, float af3,
			float bx1, float by1, float bf1, float bx2, float by2,
			float bf2, float bx3, float by3, float bf3, float px,
			float py, float pf, float (*g)(float, float),
			float re, float ae, float *surf, float surfmin)
{
	/* this function is internally used by TRICUB */

	float e,i3,i4,i5,a,b,c,sx1,sy1,sx2,sy2,sx3,sy3,cx1,cy1,cf1,
