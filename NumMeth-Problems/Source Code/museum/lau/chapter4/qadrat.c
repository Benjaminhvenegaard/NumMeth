...
float qadrat(float *x, float a, float b, float (*fx)(float),
				float e[])
{
	float lint(float *, float (*)(float), float [], float, float,
				float, float, float, float, float, float, float,
				float, float, float, float, float);
	float f0,f2,f3,f5,f6,f7,f9,f14,hmin,hmax,re,ae,result;
...
float lint(float *x, float (*fx)(float), float e[], float x0,
				float xn, float f0, float f2, float f3, float f5,
				float f6, float f7, float f9, float f14,
				float hmin, float hmax, float re, float ae)
{
	/* this function is internally used by QADRAT */

	float v,w,h,xm,f1,f4,f8,f10,f11,f12,f13;
