...
void qzi(int n, float **a, float **b, float **x, float alfr[],
			float alfi[], float beta[], int iter[], float em[])
{
	float matmat(int, int, int, int, float **, float **);
	void hshdecmul(int, float **, float **, float);
	void hestgl3(int, float **, float **, float **);
	void hsh2row3(int, int, int, int, int, float, float,
						float **, float **, float **);
	void hsh3row3(int, int, int, int, float, float, float,
						float **, float **, float **);
