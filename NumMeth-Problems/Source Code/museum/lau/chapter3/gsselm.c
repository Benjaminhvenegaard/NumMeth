...
void gsselm(float **a, int n, float aux[], int ri[], int ci[])
{
	void elmrow(int, int, int, int, float **, float **, float);
	int maxelmrow(int, int, int, int, float **, float **, float);
	void ichcol(int, int, int, int, float **);
	void ichrow(int, int, int, int, float **);
	void rowcst(int, int, int, float **, float);
	float absmaxmat(int, int, int, int, int *, int *, float **);
	int i,j,p,q,r,r1,jpiv,rank,signdet,partial;
	float crit,pivot,rgrow,max,aid,max1,eps;
