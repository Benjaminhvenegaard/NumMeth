...
void qzival(int n, float **a, float **b, float alfr[], float alfi[],
				float beta[], int iter[], float em[])
{
	void elmcol(int, int, int, int, float **, float **, float);
	void hshdecmul(int, float **, float **, float);
	void hestgl2(int, float **, float **);
	void hsh2row2(int, int, int, int, float, float,
						float **, float **);
	void hsh3row2(int, int, int, float, float, float,
						float **, float **);
	void hsh2col(int, int, int, int, float, float, float **, float **);
	void hsh3col(int, int, int, int, float, float, float,
					float **, float **);
	void chsh2(float, float, float, float, float *, float *, float *);
