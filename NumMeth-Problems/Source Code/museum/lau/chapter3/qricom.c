...
int qricom(float **a1, float **a2, float b[], int n, float em[],
				float val1[], float val2[], float **vec1, float **vec2)
{
	float *allocate_real_vector(int, int);
	void free_real_vector(float *, int);
	void comkwd(float, float, float, float,
	...
	float r,z1,z2,dd1,dd2,cc,p1,p2,t1,t2,delta1,delta2,mv1,mv2,h,h1,
