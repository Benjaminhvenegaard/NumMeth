...
vdif(a,b,dif,n)			vector difference of two vectors a and b
...
mcopy(a,aa,coln,nrow,ncol)	copy the upper left-hand portion 
						of one matrix, a,to another (aa).
						nrow rows and ncol columns are copied.
						It is assumed that both a and aa are
						dimensioned to have coln columns.
*/
