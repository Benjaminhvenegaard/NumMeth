...
header file to aid in conversion of FORTRAN code to C
(from "C Tools for Scientists and Engineers" by L. Baker)

PURPOSE:

performs in-line a number of useful chores including loops,
array subscripting, and finding minimum,maximum, and absolute value.
